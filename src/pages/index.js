...
function Home() {
  ...
  return (
    <div className='flex flex-col text-[#fff]'>
      ...
      <div className='w-screen h-screen pl-[20px] pr-[20px] sm:px-[100px] pt-[120px] sm:pt-[150px] pb-[240px] bg-[#fff] relative '>

        <div className='w-max flex mb-12'>
          <div className='p-2 flex justify-center items-center border-2 border-[#1c1c1c] rounded-full bg-none w-12 h-12 sm:w-full sm:h-full'><ArrowDown size={36} color="#1c1c1c" variant='Broken' /></div>
          <div className='p-2 px-4 sm:p-3 flex justify-center items-center sm:px-6 border-2 border-[#1c1c1c] rounded-full bg-none text-lg sm:text-xl kayak-bold text-[#1c1c1c] medium'>ABOUT</div>
        </div>
